...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Master your money with ExpenseTracer. Track, analyze, and manage your finances easily.",
    url: "https://expensetrace.vercel.app",
    siteName: "ExpenseTracer",
    images: [
      {
        url: "/logo.png",
        width: 1200,
        height: 630,
        alt: "ExpenseTracer Dashboard",
      },
    ],
    type: "website",
  },
  ...
  return (
    <>
      ...
      <main className="flex flex-col pt-24 bg-white text-black dark:bg-gray-900 dark:text-white transition-colors duration-300">
        ...
        {/* ───── Features ───── */}
        <section id="features" className="bg-gray-50 dark:bg-gray-800 py-20 px-4 md:px-6">
          <div className="container mx-auto text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-gray-600 dark:text-gray-400 md:text-lg">
              Gain clarity and control over your personal finances with these powerful tools.
            </p>
            ...
            <div className="mx-auto mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-5xl">
              {FEATURES.map(({ title, Icon, description }) => (
                <div key={title} className="space-y-4 text-left">
                  <div className="w-fit rounded-full p-3" style={{ backgroundColor: lightBlue }}>
